<%@ Page Title="Edit Entity" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEntity.aspx.cs" 
    Inherits="Portal11.Admin.EditEntity" MaintainScrollPositionOnPostback="true" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <asp:Panel ID="pnlInactive" runat="server">
            <div class="form-group">
                <div class="row">
                    <asp:Label runat="server" AssociatedControlID="chkInact" CssClass="col-sm-2 col-xs-10 control-label" Font-Bold="false">Entity is Inactive</asp:Label>
                    <div class="col-lg-4 col-md-4 col-xs-6">
                        <asp:CheckBox ID="chkInact" runat="server" CssClass="checkbox col-offset-xs-1 col-xs-1"
                            ToolTip="Turn the Entity off, disabling its use. Note: This action is difficult to undo!" />
                    </div>
                </div>
            </div>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlURL" runat="server">
            <div class="form-group">
                <div class="row">
                    <asp:Label runat="server" AssociatedControlID="txtURL" CssClass="col-sm-2 col-xs-12 control-label" Font-Bold="false">URL</asp:Label>
                    <div class="col-lg-4 col-md-4 col-xs-6">
        ...
        <div class="row">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary col-xs-offset-1 col-md-1 col-xs-2" Enabled="true"
                OnClick="Save_Click" ToolTip="Save this Entity and return to main page" />
        </div>
        </asp:Panel>
